package com.zhxd.love.constant;

import java.io.File;

/**
 * @Author hanyuhao
 * @PackageName com.zhxd.love.constant
 * @Class Constant
...
public class Constant {
    ...
    /**
     * linux与windows通用目录*/
    public static final String fileDir =  System.getProperty("user.dir") + File.separatorChar + "loveImg" + File.separatorChar;
